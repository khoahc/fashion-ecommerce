        ...
        return (
          <tr>
            ...
            <td className="image-cell">
              <div className="image">
                <img src={product.mainImage ? product.mainImage : 'https://res.cloudinary.com/hauhc/image/upload/v1667836224/lizi/products/default-clothing_wy2ygo.png'} class="rounded-full" alt="" />
              </div>
            </td>
