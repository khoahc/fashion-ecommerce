...
//            "            <p>Vui lòng click vào link dưới để xác nhận đơn hàng của bạn.</p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"[[URL]]\">Xác nhận đơn hàng</a> </p></blockquote>\n Link sẽ hết hạn sau 15 phút. <p>Cảm ơn bạn</p>" +
//            "        \n" +
//            "      </td>\n" +
//            "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
//            "    </tr>\n" +
...
//            "\n" +
//            "</div></div>\n";
    String subject = "[LIZI] - Thông tin đơn hàng của bạn";
    String content =
            "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                    "\n" +
                    "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
